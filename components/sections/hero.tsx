...
function Stars() {
  return (
    <span className="flex gap-[3px]" aria-hidden>
      {[1,2,3,4,5].map((i) => (
        <svg key={i} width="10" height="10" viewBox="0 0 10 10" fill="#a08868">
    ...
    >
      ...
      >
        <div className="w-full max-w-6xl mx-auto px-8 sm:px-12 md:px-20 pb-32 sm:pb-28 md:pb-36">
          ...
          {/* CTA-Gruppe */}
          <motion.div
            className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mb-12 md:mb-16"
          ...
          {/* Google-Rating — editorial, kein Badge */}
          <motion.div
          ...
          >
            ...
            <span
              ...
              style={{ fontSize: "15px", color: "rgba(255,255,255,0.72)", letterSpacing: "-0.01em" }}
            >
              {SALON.google.score}
            </span>
            <div style={{ width: "1px", height: "12px", backgroundColor: "rgba(255,255,255,0.14)" }} />
            <span
              style={{ fontSize: "11px", letterSpacing: "0.06em", color: "rgba(255,255,255,0.30)" }}
            >
              {SALON.google.count} Bewertungen · Google
            </span>
          </motion.div>
