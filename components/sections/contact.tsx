    ...
    <section id="kontakt" style={{ backgroundColor: "#1c1f1f" }} className="py-16 md:py-28">
      <div className="max-w-6xl mx-auto px-8 sm:px-12 md:px-16">
        ...
        >
          ...
          {/* ── Linke Spalte: Kontakt-Info ── */}
          <div>
            <motion.p variants={fadeUp()} className="text-[10px] tracking-[0.40em] uppercase font-medium mb-8" style={{ color: "#a08868" }}>
              Kontakt
            </motion.p>

            <motion.h2 variants={fadeUp(0.04)} className="font-display font-light italic leading-[1.06] mb-5"
              style={{ fontSize: "clamp(2.6rem, 5vw, 4rem)", color: "#F5F3EE", letterSpacing: "-0.024em" }}>
              Komm vorbei.
            </motion.h2>

            <motion.p variants={fadeUp(0.08)} className="mb-10 leading-relaxed"
            ...
            <motion.div variants={fadeUp(0.12)}>
              <motion.a
                ...
                style={{ fontSize: "13px", letterSpacing: "0.06em", backgroundColor: "rgba(160,136,104,0.13)", border: "1px solid rgba(160,136,104,0.42)", height: "56px", paddingLeft: "26px", paddingRight: "30px", borderRadius: "9999px" }}
          ...
          <motion.div variants={fadeUp(0.1)}>
            {/*
              Ein einziger JSX-Baum für beide Breakpoints.

              Mobile  : flex-col → Karte (240px) oben, Glass-Card darunter im Flow
              Desktop : block relative aspect-video overflow-hidden → Glass-Card
                        wird per lg:absolute aus dem Flow gehoben und über die Karte gelegt
            */}
            <div
              className={[
                // Mobile: gestapeltes Flex-Layout
                "flex flex-col gap-3",
                // Desktop: positioned block mit 16:9-Verhältnis
                "lg:block lg:relative lg:aspect-video lg:rounded-[22px] lg:overflow-hidden lg:bg-[#0e1010]",
                "lg:shadow-[0_30px_80px_rgba(0,0,0,0.55),0_0_0_1px_rgba(255,255,255,0.055)]",
              ].join(" ")}
            >

              {/* Kartenbild + Overlays + Pin
                  Mobile:  h-[240px], eigene border-radius + shadow
                  Desktop: absolute inset-0, kein eigener radius/shadow (kommt vom Elternelement)
              */}
              <div
                className={[
                  "relative overflow-hidden bg-[#0e1010]",
                  // Mobile-spezifisch
                  "h-[240px] rounded-[22px]",
                  "shadow-[0_20px_50px_rgba(0,0,0,0.55),0_0_0_1px_rgba(255,255,255,0.055)]",
                  // Desktop-Override: Karte füllt den gesamten Eltercontainer
                  "lg:absolute lg:inset-0 lg:h-auto lg:rounded-none lg:shadow-none",
                ].join(" ")}
              >
                <Image
                  ...
                  style={{ objectFit: "cover", objectPosition: "52% 44%", filter: "saturate(0.82) brightness(0.86) contrast(1.07)" }}
                />
                ...
                {/* Gold-Pin */}
                <div style={{ position: "absolute", left: `${PIN_LEFT}%`, top: `${PIN_TOP}%`, transform: "translate(-50%, -100%)", zIndex: 10 }}>
              ...
              {/* Glass-Card
                  Mobile:  normaler Flex-Flow-Eintrag, volle Breite
                  Desktop: absolut positioniert über der Karte, feste Breite rechts
              */}
              <div
                className={[
                  "rounded-[18px]",
                  ...
                  "lg:right-[clamp(16px,3vw,28px)]",
                  "lg:w-[clamp(220px,28%,280px)]",
                ].join(" ")}
                style={{
                  padding:         "22px",
                  backgroundColor: "rgba(10,12,12,0.82)",
              ...
              >
                ...
                <p className="font-display font-light italic leading-tight mb-4"
                ...
                <div className="mb-6" style={{ fontSize: "12.5px", color: "rgba(245,243,238,0.52)", lineHeight: 1.7 }}>
                  <p>{SALON.street}</p>
                  <p>{SALON.city}</p>
                  <p style={{ fontSize: "11px", color: "rgba(245,243,238,0.26)", marginTop: "4px" }}>5 Min. · U-Bahn Billstedt</p>
                </div>

                <motion.a
                  href={SALON.mapsUrl} target="_blank" rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 w-full font-medium"
                  style={{ fontSize: "10.5px", letterSpacing: "0.15em", textTransform: "uppercase", color: "#c4a882", backgroundColor: "rgba(160,136,104,0.09)", border: "1px solid rgba(160,136,104,0.26)", borderRadius: "9999px", height: "42px" }}
