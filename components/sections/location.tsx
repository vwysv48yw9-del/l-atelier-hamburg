...
/* ─── Wiederverwendbare Teilelemente ─────────────────────────────── */

/** Kartenbild + Overlays + Pin — in einem `position:relative`-Elternelement. */
function MapContent() {
  return (
    <>
      <Image
        ...
        fill
        sizes="(max-width: 767px) 100vw, (max-width: 1024px) 100vw, 864px"
        style={{
          objectFit:      "cover",
...
/** Inhalt der Glass-Card (ohne Positionierung). */
function CardContent() {
  return (
    <>
      ...
      <p className="font-display font-light italic leading-tight mb-5"
      ...
      <div className="flex items-center gap-2 mb-5">
        ...
        <span style={{ fontSize: "10px", color: "rgba(255,255,255,0.28)", letterSpacing: "0.03em" }}>· Google</span>
      </div>
    ...
    >
      <div className="max-w-5xl mx-auto px-8 sm:px-12 md:px-20">
        ...
        >
          ...
          {/* ══════════════════════════════════════════
              MOBILE  (< md / < 768px)
              Karte oben — Glass-Card darunter im Flow
          ══════════════════════════════════════════ */}
          <div className="block md:hidden">
            ...
            <div
              style={{
                ...
                boxShadow:       "0 20px 50px rgba(0,0,0,0.55), 0 0 0 1px rgba(255,255,255,0.055)",
              }}
            >
              <MapContent />
            </div>

            {/* Glass-Card — normaler Dokumentenfluss, kein absolute */}
            <div
              style={{
                marginTop:       "12px",
          ...
          >
            ...
            {/* Glass-Card — absolut positioniert wie bisher */}
            <div
              style={{
                position:        "absolute",
